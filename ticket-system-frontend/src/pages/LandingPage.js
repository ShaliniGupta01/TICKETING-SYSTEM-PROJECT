...
//   // State to hold first message temporarily
...
//   // First ever message → show form first
//   if (!formCompleted && !showForm) {
//     setFirstMessage(userMessage); // save this first message
//     setShowForm(true);
//     return;
//   }

//   if (!ticketId) {
//     // Ticket not yet created, wait for form submit
//     console.warn("Ticket not yet created. Wait for form submit.");
//     return;
//   }

//   try {
//     // Ticket exists → add message
...
//     setMessages((prev) => [
//       ...prev,
//       { sender: "bot", text: "Message delivered" },
//     ]);
//   } catch (err) {
//     console.error(err);
//     setMessages((prev) => [
//       ...prev,
//       { sender: "bot", text: "Message could not be delivered." },
//     ]);
//   }
// };


// // Form submit for chat intro
...
//     // Backend returns { message: "...", ticketId: "abcd1234" }
//     const newTicketId = res.data.ticketId;
//     if (!newTicketId) {
//       console.error("Ticket creation failed or invalid response");
//       setMessages((prev) => [
//         ...prev,
...
//   // Hide chatbot after scrolling
//   useEffect(() => {
//     const handleScroll = () => {
//       const heroSectionHeight =
//         document.querySelector(".hero-section")?.offsetHeight;
//       setShowChatBot(window.scrollY <= heroSectionHeight);
//     };
...
//                             <label className="intro-title">
//                               Introduce Yourself
//                             </label>
//                             <form
//                               onSubmit={handleFormSubmit}
//                               className="intro-chat-form"
//                             >
...
//                 <form
//                   className="chats-input-container"
...
//             <span className="highlight-text">Hubly CRM</span>
//           </h1>
//           <p>
...
//             alt="Bottom Right"
//             className="hero-overlay bottom-right"
//           />
//           <img
//             src={bottomLeftImage}
//             alt="Bottom Left"
//             className="hero-overlay bottom-left"
//           />
//         </div>
//       </section>
...
//           {[adobeLogo, elasticLogo, opendoorLogo, airtableLogo, elasticLogo, framerLogo].map(
//             (logo, i) => (
...
//           automate tasks — saving you time and maximizing revenue.
//         </p>
